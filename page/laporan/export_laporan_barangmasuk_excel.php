...
{?>
 ...
 <?php
	...
	header("Content-Disposition: attachment; filename=Laporan_Bahan_Baku_Masuk (".date('d-m-Y').").xls");
...
<body>
<center>
<h2>Laporan Bahan Baku Masuk Bulan <?php echo $bln;?>, Tahun <?php echo $thn;?></h2>
</center>
<table border="1">
<tr>
					<th>No</th>
