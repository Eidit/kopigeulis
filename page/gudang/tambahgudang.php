...
if(strlen($tambah) == 1){
	$format = "BBK-".$bulan.$tahun."00".$tambah;
} else if(strlen($tambah) == 2){
	$format = "BBK-".$bulan.$tahun."0".$tambah;
	
} else{
	$format = "BBK-".$bulan.$tahun.$tambah;
              ...
              <div class="table-responsive">
						...
						<label for="">Jenis Kopi</label>
							...
							if (isset($_POST['simpan'])) {
								...
								$sql = $koneksi->query("insert into gudang (kode_barang, jenis_barang, jumlah, satuan, nama_palet ) values('$kode_barang','$jenis_barang','$jumlah','$satuan','$palet')");
