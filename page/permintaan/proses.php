  <?php
        $id = $_GET['id'];
	$sql = $koneksi->query("select * from permintaan where id = '$id'");
  ...
  <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Pengajuan Bahan Baku</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
							...
							if (isset($_POST['simpan'])) {
								...
								$sql = $koneksi->query("insert into permintaan_proses (tanggal, id_produk, jenis_produk, jumlah) values('$tanggal','$id_produk','$jenis_produk','$jumlah')");
