...
<head>
	...
	<style>
		body {
	          background: url(img/wpp.jfif) no-repeat fixed;
				...
				<br>
					...
					<div class="form-group">
						<select name="level" class="form-control" required>
							...
							<option value="superadmin">Bahan Baku</option>
							<option value="petugas">Produk</option>
	...
	error_reporting(0);
					...
					if ($login) {
						...
						if ($ketemu >=1) {
							...
							echo '<center><div class="alert alert-danger">Username atau Password Salah. Silahkan Coba Kembali !</div></center>';
