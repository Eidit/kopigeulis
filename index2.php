  ...
  <!-- Nav Item - Dashboard -->
      ...
      <li class="nav-item active">
        ...
        <div id="collapseDataa" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
            <a class="collapse-item" href="?page=permintaan">Permintaan Produksi</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseData1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
            <a class="collapse-item" href="?page=produkmasuk">Produk</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseData2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
            <a class="collapse-item" href="?page=produkkeluar">Produk</a>
          </div>
        </div>
      </li>
	   ...
	   <li class="nav-item active">
        ...
        <div id="collapseLaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=laporan_produkmasuk">Laporan Produk Masuk</a>
            <a class="collapse-item" href="?page=laporan_produkkeluar">Laporan Produk Keluar</a>
          </div>
        </div>
      </li>
        ...
        <div class="container-fluid">
		 ...
		 <section class="content">
		      ...
		      <?php
			   ...
			   if ($page == "permintaan") {
				   if ($aksi == "") {
					   include "page/permintaan/permintaan.php";
				   }
				   if ($aksi == "proses") {
					   include "page/permintaan/proses.php";
				   }
			   }
